...
struct config
{
 size_t vector_size =1024*1024*256; //define size as number of elements (4 byte int)
 int omp_threads =8;
 size_t kib=0;
 size_t mib=1024;
 bool usm=true;
...
int main(int argc, char* argv[]) {
  ...
  std::cout << "Available SYCL Platforms: "<<std::endl;
  ...
  size_t vector_size =1024*1024*256; //1 Gib per array int
